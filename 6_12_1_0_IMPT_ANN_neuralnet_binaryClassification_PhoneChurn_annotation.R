...
##  ===================================================    
    ...
    ##  (a) using the predict function
    ##  --------------------------------------------------
        pred <- predict(net, phone_test[,-6])  # we can also use predict()
    ...
    ##  -----------------------------------------    
        ...
        predcat <- ifelse(pred<mean(pred), 0, 1)
        
        
    ##  (c) build the classification table
    ##  --------------------------------------    
        table(predicted = predcat, actual = phone_test$churn)
