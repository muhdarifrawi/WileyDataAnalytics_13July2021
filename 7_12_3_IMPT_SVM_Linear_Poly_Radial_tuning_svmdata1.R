...
##  -----------------
    ...
    View(nonlineardata) 
    str(nonlineardata)
      # nonlineardata$y <- as.factor(nonlineardata$y)
...
##  ========================
    ...
    plot(tuned_svm_linear, data = test) # on testing set
      ...
      # data.frame(predicted=pred, actual=test$y)
...
##  ============================
    ...
    # ?svm
    tuned_svm_polynomial$best.parameters
